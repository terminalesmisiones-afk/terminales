...
const Footer: React.FC<FooterProps> = ({ className = "" }) => {
  ...
  return (
    <footer className={`bg-gray-900 text-white pt-8 pb-12 ${className}`}>
      {/* Footer Banners */}
      {banners.length > 0 && (
        <div className="w-full mb-8 overflow-hidden">
          <div className="max-w-7xl mx-auto px-4">
            {banners.map((banner) => (
              <div key={banner.id} className="w-full flex justify-center mb-4 last:mb-0">
                {banner.uploadType === 'html' ? (
                  ...
                  >
                    <img
                      src={banner.imageUrl}
                      alt={banner.title}
                      className="w-full h-auto object-contain max-h-[100px] md:max-h-[150px] mx-auto rounded-lg opacity-90 hover:opacity-100 transition-opacity"
                    />
                  </a>
                )}
              </div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li>
                <button
                  ...
                  className="hover:text-white transition-colors text-left flex items-center gap-2 opacity-50 hover:opacity-100"
                >
